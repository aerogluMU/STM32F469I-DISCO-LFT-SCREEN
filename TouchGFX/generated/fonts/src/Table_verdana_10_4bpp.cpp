...
KEEP extern const touchgfx::GlyphNode glyphs_verdana_10_4bpp[] FONT_TABLE_LOCATION_FLASH_ATTRIBUTE = {
    ...
    {    56, 0x006F,   6,   6,   6,   0,   6,   0,   0, 0x00 },
    {    74, 0x0072,   5,   6,   6,   0,   4,   0,   0, 0x00 },
    {    92, 0x0073,   5,   6,   6,   0,   5,   0,   0, 0x00 }
};
...
touchgfx::GeneratedFont& getFont_verdana_10_4bpp()
{
    static touchgfx::GeneratedFont verdana_10_4bpp(glyphs_verdana_10_4bpp, 5, 10, 0, 4, 1, 0, 1, unicodes_verdana_10_4bpp, kerning_verdana_10_4bpp, 63, 0, 0, 0);
