...
typedef struct{
	...
	uint8_t uart6_doors_flag;	/*!< possible values from @USART6_DOORS_FLAGS >*/
	uint8_t uart6_lnend_flag;	/*!< possible values from @USART6_LNEND_FLAGS >*/
	uint8_t system_begin_flag;	/*!< possible values from @SYSTEM_BEGIN_FLAGS >*/
}lft_flags;
...
#define USART6_DOORS_FLAG_NCON  			0
#define USART6_DOORS_FLAG_CON  				1
...
#define USART6_LNEND_FLAG_NO  				0
#define USART6_LNEND_FLAG_YES  				1
...
#define SYSTEM_BEGIN_FLAGS_NO  				0
#define SYSTEM_BEGIN_FLAGS_YES  			1
